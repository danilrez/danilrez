...
<p style="font-family:'Segoe UI';font-weight:bold;text-shadow:-4px -4px 0px #90a0ad;background: repeating-linear-gradient(30deg,#c5d2db50,#c5d2db50 1px,#ffffff00 2px,#ffffff00 3px);-webkit-background-clip: text;-webkit-text-fill-color: transparent;"> Hi there! My name is Danil! <img src="https://raw.githubusercontent.com/MartinHeinz/MartinHeinz/master/wave.gif" width="25px"></p>
